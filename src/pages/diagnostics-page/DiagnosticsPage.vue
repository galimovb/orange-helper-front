    ...
    <div class="flex lg:flex-row flex-col gap-6 items-center">
      <div class="flex flex-col lg:gap-16 gap-6">
        ...
        <p class="text-4xl leading-[100%]">
          Данный раздел посвящен психологическому и педагогическому материалу, включающий в себя адаптированную литературу, а также тестирования.педагогами и психологами.
        </p>
      </div>
      <img
